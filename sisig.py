...
try:
    ...
    browse_recipes_img = Image.open("images/sisig.jpg")  # Replace with your image path
...
title_label = tk.Label(title_frame, text="Sisig", font=("Arial", 20, "bold"))
title_label.pack()
...
description_text = tk.Label(description_frame, text="Sisig is a popular Filipino dish made from chopped pork, pig ears, and chicken liver, seasoned with citrus, soy sauce, and spices. It's often served sizzling hot.", wraplength=360, justify="left")
...
instructions_text = tk.Label(instructions_frame, text="Boil pork belly, pig ears, and chicken liver until tender. Drain and chop into small pieces. Sauté onion and garlic in oil until fragrant. Add the chopped pork, pig ears, and liver. Add soy sauce, chili peppers, calamansi juice, pepper, and salt. Mix well. Top with mayonnaise and stir to combine. If desired, add an egg on top and cook until set. Serve hot, typically on a sizzling plate.", wraplength=360, justify="left")
