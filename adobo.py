...
try:
    ...
    browse_recipes_img = Image.open("images/adobo.jpg")  # Replace with your image path
...
title_label = tk.Label(title_frame, text="Adobo", font=("Arial", 20, "bold"))
title_label.pack()
...
description_text = tk.Label(description_frame, text="Adobo is a classic Filipino dish made with chicken or pork, marinated in soy sauce, vinegar, garlic, and bay leaf, then simmered to perfection. It offers a savory and tangy flavor that's truly comforting.", wraplength=360, justify="left")
...
instructions_text = tk.Label(instructions_frame, text="Marinate meat with soy sauce, vinegar, garlic, and bay leaf for at least 30 minutes. Saut\u00e9 onion and garlic in oil, then add marinated meat. Add water, peppercorns, and simmer until meat is tender. Season with salt and pepper to taste.", wraplength=360, justify="left")
